...
export default {
  ...
  computed: {
    ...
    classObject() {
      return {
        ...
        "o-infinity-upgrade-btn--bought": !(this.isUseless && this.upgrade.id == 17) && this.isBought,
        "o-infinity-upgrade-btn--available": !(this.isUseless && this.upgrade.id == 17) && this.canBeBought,
        "o-infinity-upgrade-btn--unavailable": !(this.isUseless && this.upgrade.id == 17) && !this.isBought && !this.canBeBought,
        "o-infinity-upgrade-btn--useless": this.isUseless && this.upgrade.id == 17,
  ...
  methods: {
    update() {
      ...
      this.isUseless = upgrade.config.pelle && Pelle.isDoomed;
