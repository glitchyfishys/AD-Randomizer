...
export default {
  ...
  computed: {
    grid() {
      return [
        [
          InfinityUpgrade.all[0],
          InfinityUpgrade.all[1],
          InfinityUpgrade.all[2],
          InfinityUpgrade.all[3]
        ],
        [
          InfinityUpgrade.all[4],
          InfinityUpgrade.all[5],
          InfinityUpgrade.all[6],
          InfinityUpgrade.all[7]
        ],
        [
          InfinityUpgrade.all[8],
          InfinityUpgrade.all[9],
          InfinityUpgrade.all[10],
          InfinityUpgrade.all[11]
        ],
        [
          InfinityUpgrade.all[12],
          InfinityUpgrade.all[13],
          InfinityUpgrade.all[14],
          InfinityUpgrade.all[15]
        ]
      ];
    },
    allColumnUpgrades() {
    ...
    offlineIpUpgrade: () => InfinityUpgrade[16]
  },
  watch: {
    disCharge(newValue) {
  ...
  methods: {
    update() {
      ...
      this.ipMultSoftCap = GameDatabase.infinity.upgrades[17].costIncreaseThreshold;
      this.ipMultHardCap = GameDatabase.infinity.upgrades[17].costCap;
      this.eternityUnlocked = PlayerProgress.current.isEternityUnlocked;
      this.bottomRowUnlocked = Achievement(41).canBeApplied;
    },
