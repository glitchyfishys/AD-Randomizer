...
export class TimeStudyTreeLayout {
  constructor(type, scaling = 1) {
    ...
    const TS = id => (TimeStudyWithIds(id).isUnlocked ? TimeStudyWithIds(id) : null);
    ...
    this.rows = [
      ...
      normalRow(                       null,   TS(51),  TS(52)                        ),

      normalRow(                       null,   TS(61),  null                          ),
    ...
    if (type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_181 || type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_TRIAD_STUDIES) {
      this.rows.push(
