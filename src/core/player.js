...
window.player = {
  ...
  speedrun: {
    ...
    startDate: 0,
    name: `Antimatter Dimensions Archipalego`,
    offlineTimeUsed: 0,
  ...
  reality: {
    ...
    glyphs: {
      ...
      cosmetics: {
        ...
        unlockedFromNG: Object.keys(GameDatabase.reality.glyphCosmeticSets),
        symbolMap: {},
        colorMap: {},
      }
    },
  ...
  archipelago: {
    ...
    lastPassword: "",
    isArch: false,
    rebuyableUpgrades: Array.repeat(0, 7),
  },
  seed: Math.floor(Date.now() * Math.random() + 1287),
};
