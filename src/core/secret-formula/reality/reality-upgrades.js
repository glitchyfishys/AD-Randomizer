...
export const realityUpgrades = [
  ...
  },
  {
    ...
    id: 16,
    cost: 1500,
    requirement: () => `Reality with ${formatInt(3)} Glyphs equipped of uncommon or better rarity
  ...
  },
  {
    ...
    id: 17,
    cost: 1500,
    requirement: () => `Reality with ${formatInt(3)} Glyphs equipped, each having at least ${formatInt(2)} effects
  ...
  },
  {
    ...
    id: 18,
    cost: 1500,
    requirement: () => `Reality with ${formatInt(3)} Glyphs equipped, each at level ${formatInt(10)} or higher
