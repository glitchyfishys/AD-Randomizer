...
export const perks = {
  ...
  autocompleteEC1: {
    ...
    get description() {
      return `Auto-complete one Eternity Challenge every ${formatInt(10)} minutes (real-time).
              ECs will be completed sequentially, requiring all previous
              ECs to be fully completed before progressing to the next EC.`;
    },
    effect: 10,
    automatorPoints: 5,
    shortDescription: () => `Auto-complete ECs every ${formatInt(10)} minutes`,
  },
  autocompleteEC2: {
    id: 61,
    label: "PEC2",
    family: PERK_FAMILY.AUTOMATION,
    get description() {
      return `Auto-complete one Eternity Challenge every ${formatInt(3)} minutes (real-time).
        (${formatInt(7)} minute decrease)`;
    },
    effect: 3,
  },
  autocompleteEC3: {
    ...
    family: PERK_FAMILY.AUTOMATION,
    get description() {
      return `Auto-complete one Eternity Challenge every ${formatInt(30)} seconds (real-time).
        (${formatInt(150)} second decrease)`;
    },
    effect: 0.5,
    automatorPoints: 10,
    shortDescription: () => `Auto-complete ECs every ${formatInt(30)} seconds`,
  },
  studyActiveEP: {
    id: 70,
    label: "ACT",
