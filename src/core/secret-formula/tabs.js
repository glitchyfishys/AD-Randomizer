  ...
  },
  {
    ...
    subtabs: [
      ...
      },
      {
        ...
        symbol: "⌬",
        component: "VTab",
        condition: () => Achievement(151).isUnlocked || Achievement(151).isEffectActive,
        id: 4,
        hidable: true,
      },
      {
    ...
    subtabs: [
      {
        key: "join",
        name: "Join",
        symbol: "<i class='fas fa-network-wired'></i>",
        component: "ArchJoinTab",
        id: 0,
        hidable: true,
      },
      {
        key: "buffs",
        name: "Buffs",
        symbol: "<i class='fas fa-arrow-turn-up'></i>",
        component: "ArchBuffsTab",
        id: 1,
        hidable: true,
      },
      {
        key: "items",
        name: "Items",
        symbol: "<i class='fas fa-box-open'></i>",
        component: "ArchItemsTab",
        id: 2,
        hidable: true,
      },
      {
        key: "chat",
        name: "Chat",
        symbol: "<i class='fas fa-message'></i>",
        component: "ArchChatTab",
        id: 3,
        hidable: true,
      },
      {
        key: "std",
        name: "STDs",
        symbol: "<i class='fas fa-store'></i>",
        component: "ArchSTDUpgradeTab",
        id: 4,
        hidable: true,
      },
    ]
