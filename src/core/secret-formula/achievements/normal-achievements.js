...
export const normalAchievements = [
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Start with ${formatInt(5e5)} antimatter.`; },
    effect: 5000
  },
  {
    id: 38,
  ...
  },
  {
    ...
    checkRequirement: () => (player.infinityUpgrades & 2 ** 16 - 1) === 2 ** 16 - 1,
    checkEvent: [
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Start with ${format(5e25)} antimatter.`; },
    effect: 5e10
  },
  {
    id: 56,
  ...
  },
  {
    ...
    get description() { return `Play for ${formatInt(1)} hour.`; },
    checkRequirement: () => Time.totalTimePlayed.totalHours >= 1,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    reward: "Small multiplier to Antimatter Dimensions based on time played.",
    effect: () => Math.max(Math.pow(Time.totalTimePlayed.totalHours, 1.25), 1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 77,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Start with ${format(5e50)} antimatter.`;
    },
    effect: 5e50
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
      return `Infinities more than ${formatInt(3)} seconds long
      give ${formatX(1000)} more Infinities.`;
    },
    effect: 1000,
    effectCondition: () => Time.thisInfinity.totalSeconds > 3
  },
  {
    id: 88,
  ...
  },
  {
    ...
    get description() {
      ...
      for ${formatInt(30)} consecutive seconds during a single Infinity.`;
    },
  ...
  },
  {
    ...
    get reward() {
      ...
      after Eternity you permanently keep ${formatPercents(0.25)} of your Infinities as Banked Infinities.`;
    },
    effects: {
      infinitiesGain: 2,
      bankedInfinitiesGain: () => Currency.infinities.value.times(0.25).floor()
    }
  ...
  },
  {
    ...
    get description() { return `Reach ${formatPostBreak(DC.E14000)} Replicanti.`; },
    checkRequirement: () => Replicanti.amount.exponent >= 14000,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
  ...
  },
  {
    id: 166,
    name: "Nicenice.",
    get description() { return `Get a Glyph with at least level ${formatInt(6969)}.`; },
